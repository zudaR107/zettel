...
const SECTIONS: Section[] = [
  ...
  {
    titel: 'Экспорт',
    text: 'В «Настройках» можно скачать JSON со всеми заметками Zettel, их тегами и архивным состоянием. Экспорт относится только к данным Zettel, а не ко всему аккаунту Hof.',
  },
  {
